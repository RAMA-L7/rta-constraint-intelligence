...
set_false_path -from [get_ports din2] -to [get_ports dout]
set_multicycle_path 2 -setup -from [get_ports din2] -to [get_ports dout]
set_multicycle_path 1 -hold -from [get_ports din2] -to [get_ports dout]
