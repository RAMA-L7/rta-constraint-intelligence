...
> **Date:** 2026-08-12 · **Baseline:** v1.5.1 published to PyPI; Streamlit app live on Community Cloud; full suite 767/767 green
...
| PyPI install (`pip install rta-constraint-intelligence`) | ✅ done | v1.5.1 live, wheel+sdist, `[web]` extra verified |
