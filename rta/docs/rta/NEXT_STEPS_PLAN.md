...
> **Date:** 2026-08-12 · **Baseline:** v1.5.3 published to PyPI; Streamlit app live on Community Cloud; full suite green
...
| PyPI install (`pip install rta-constraint-intelligence`) | ✅ done | v1.5.3 live, wheel+sdist, `[web]` extra verified |
