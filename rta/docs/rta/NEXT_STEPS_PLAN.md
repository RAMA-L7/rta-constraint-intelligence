...
> **Date:** 2026-08-12 · **Baseline:** v1.5.4 published to PyPI; Streamlit app live on Community Cloud; full suite green
...
| PyPI install (`pip install rta-constraint-intelligence`) | ✅ done | v1.5.4 live, wheel+sdist, `[web]` extra verified |
