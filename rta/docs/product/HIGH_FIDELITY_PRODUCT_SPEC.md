...
│ └───────────────────────────────────────────────────────────────────────┘ │
│ ┌─ BENCHMARK EVIDENCE ──────────────────────────────────────────────────┐ │
│ │  809 pytest · 9/9 golden · 42/42 suites · 17/17 clean-room ·          │ │
...
INPUT (SDC [+ Verilog])
  ...
  → VALIDATE (115 rules · semantic checks)
...
KEY VERIFIED RESULTS (6 Evidence Metric cards)
  809 pytest  |  9/9 golden runners  |  42/42 benchmark suites
...
appear literally: 809 pytest · 9/9 golden · 42/42 suites · 17/17 clean-room ·
...
| Rules | 115 rules across 7 modules (rules_registry.py) |
...
- Workspace: Interactions full page · Design Context full page · source syntax
  highlighting · light mode · docs search · rule pages for all 115 rules.
