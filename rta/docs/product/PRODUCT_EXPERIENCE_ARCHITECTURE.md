...
| Rules catalog | **111 rules** (70 checker · 21 constraint_diff · 5 design_context · 4 mmc · 4 clock_relations · 4 constraint_interactions · 3 design_coverage) |
...
| 2 | Deterministic rule checking (111 rules) | Errors/warnings/info with provenance | PD/STA/constraints | `checker.py` + `rules_registry.py` | `check` | ✅ | ✅ | No | VALIDATED (per command) |
...
- **`rules_registry.py`** → rule catalog pages (111 rules, descriptions, fixes, versions).
