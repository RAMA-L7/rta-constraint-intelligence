#!/usr/bin/env python3
"""
Comprehensive SDC Tools feature test.
...
check_files = [
    ("samples/check_variants/good_complex.sdc", 0, 3, "Good complex SDC"),
    ("samples/check_variants/minimal_but_valid.sdc", 0, 5, "Minimal valid SDC"),
    ("samples/real_design_full.sdc", 0, 10, "Real design full"),
    ("samples/buggy_no_clocks.sdc", 1, 10, "Buggy — no clocks"),
    ("samples/edge_case_malformed.sdc", 1, 20, "Malformed SDC"),
    ("samples/edge_case_empty.sdc", 1, 10, "Empty file"),
    ("samples/edge_case_extreme_values.sdc", 1, 20, "Extreme values"),
]
